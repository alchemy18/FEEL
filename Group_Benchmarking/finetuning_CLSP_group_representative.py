...
def run_training_once(df_train_full, df_test_full1,df_test_full2, feature_cols, label_col, ckpt_path, percentage,
    ...
    # Sample equal percentage from each group within each class
    ...
    if label_col == "arousal_category":
        ...
        text_class = ["The participant felt bad and was in a negative mood, with emotions like sadness, fear, depression, anger, stress, worry, hopelessness, and frustration.", "The participant experienced a positive mood characterized by emotions such as joy, gratitude, serenity, interest, hope, pride, amusement, inspiration, awe, happy and love."]
