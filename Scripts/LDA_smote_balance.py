...
def Arousal(PathFile,output_file=None):
    ...
    for pi in tqdm(X_train['PID'].unique(), desc='Processing PID'):
        ...
        accuracy_arousal_LDA[pi], balanced_acc_arousal_LDA[pi], r2_a[pi], mse_a[pi], f1_a[pi] = train_LDA_arousal(
...
def Valence(PathFile,output_file=None):
    ...
    for pi in tqdm(X_train['PID'].unique(), desc='Processing PID'):
        ...
        accuracy_valence_LDA[pi], balanced_acc_valence_LDA[pi], r2_v[pi], mse_v[pi], f1_v[pi] = train_LDA_valence(
