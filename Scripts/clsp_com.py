...
def Arousal(com_path):  

    combined_df=csv_read(com_path)
    combined_df = combined_df.fillna(0)
    combined_df.replace([np.inf, -np.inf], 0, inplace=True)

    relevant_features_combined = ['BPM', 'PPG_Rate_Mean', 'HRV_MedianNN', 'HRV_Prc20NN',
    ...
    model_path = "/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/CLSP_Models/Zer-shot/best_combined_arousal_category_42.pt"
    X_test = combined_df[fet]
    test_y = combined_df['arousal_category'].to_list()
...
def Valence(com_path):
    ...
    model_path = "/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/CLSP_Models/Zer-shot/best_combined_valence_category_42.pt"
    X_test = combined_df[fet]
    test_y = combined_df['valence_category'].to_list()
...
# ppg_path = "/mnt/drive/home/pragyas/Pragya/EEVR_Extension/zero-shot/emowear/emowear_BVP_scaled.csv"

# test_arousal(eda_path = eda_path, ppg_path = ppg_path)

# test_valence(eda_path = eda_path, ppg_path = ppg_path)

# com_fet_path = "/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/Datasets/UBFC/Features_Combined.csv"
# Arousal(com_path= com_fet_path)
# Valence(com_path=com_fet_path)
