...
if __name__ == "__main__":
    ...
    modalities = {
        "EDA": {
            ...
            "csv": f"/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/Datasets/{dataset_name}/Features_EDA.csv",
            "ckpt": {
                "arousal_category": "best_eda_arousal_category_42.pt",
                "valence_category": "best_eda_valence_category_42.pt"
            }
        },
        "PPG": {
            "feature_cols": feature_PPG,
            "csv": f"/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/Datasets/{dataset_name}/Features_PPG.csv",
            "ckpt": {
                "arousal_category": "best_ppg_arousal_category_42.pt",
                "valence_category": "best_ppg_valence_category_42.pt"
            }
        },
        "Combined": {
            "feature_cols": feature_Combined,
            "csv": f"/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/Datasets/{dataset_name}/Features_Combined.csv",
            "ckpt": {
                "arousal_category": "best_combined_arousal_category_42.pt",
                "valence_category": "best_combined_valence_category_42.pt"
            }
        }
    }
                            ...
                            for n_ctx in [16]:
                                ...
                                for me in [ 16, 32, 256]:
                                    ...
                                    model = train_cocoop(
                                        ...
                                        ckpt_path=f"/mnt/drive/home/pragyas/Pragya/Benchmarking_IMWUT/CLSP_Models/Zer-shot/{modality_data['ckpt'][label]}",
