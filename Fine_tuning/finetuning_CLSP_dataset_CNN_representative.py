...
def load_pretrained_clsp(ckpt_path, feature_dim, n_ctx=None, meta_hidden_channel=None, device='cuda'):
...
def train_cocoop(dataset_name, csv_path, ckpt_path=None, feature_cols=None, label_col=None, percentage=None,
    ...
    print(f"  • Meta-Net Hidden Channel dim: {meta_hidden_channel}")
    print("-"*80)
    ...
    test_acc_2, test_f1_2, trainpercentage_acc_2, trainpercentage_f1_2 = run_training_once(
        ...
        ckpt_path, percentage, batch_size, epochs, lr, n_ctx, meta_hidden_channel, device, run_name_2,
