...
def train_random_forest_arousal(X_train, y_train_arousal, X_test, y_test_arousal, X_test1,y_test_arousal1,gr):
    ...
    y_pred_arousal_RF1 = model_arousal_RF.predict(X_test1)
    accuracy_arousal_RF1 = accuracy_score(y_test_arousal1, y_pred_arousal_RF1)
    f1_a1 = f1_score(y_test_arousal1, y_pred_arousal_RF1)

    with open("<path to save the model>",'wb+') as file:
        pickle.dump(model_arousal_RF, file)


    return accuracy_arousal_RF*100, f1_a, accuracy_arousal_RF1*100, f1_a1
...
def Arousal(PathFile, test_path_list):
    ...
    accuracy_arousal_RF,f1_a, accuracy_arousal_RF1, f1_a1 =train_random_forest_arousal(train_x,train_arousal,test_x,test_arousal,test_x1,test_arousal1,gr)

        
    return round(accuracy_arousal_RF,3), round(f1_a,3), round(accuracy_arousal_RF1,3), round(f1_a1,3)

def train_random_forest_valence(X_train, y_train_valence, X_test , y_test_valence,X_test1,y_test_valence1,gr):
    ...
    y_pred_valence_RF1 = model_valence_RF.predict(X_test1)
    accuracy_valence_RF1 = accuracy_score(y_test_valence1, y_pred_valence_RF1)
    f1_v1 = f1_score(y_test_valence1, y_pred_valence_RF1)

    with open("<path to save the model>",'wb+') as file:
        pickle.dump(model_valence_RF, file)

    return accuracy_valence_RF*100, f1_v, accuracy_valence_RF1*100, f1_v1
...
def Valence(PathFile, test_path_list):
    ...
    accuracy_valence_LDA,f1_v, accuracy_valence_LDA1, f1_v1 =train_random_forest_valence(train_x,train_valence,test_x,test_valence,test_x1,test_valence1,gr)
